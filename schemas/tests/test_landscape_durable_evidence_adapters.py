...
def test_sources_run_end_to_end_into_eligible_memory_cycle():
    sources = [
        {"source_kind":"git_commit","source_id":"git:state","requirement_id":"primary-state","sha":"abc","retrieved":True},
        {"source_kind":"receipt","source_id":"receipt:causal","requirement_id":"causal-link","receipt_id":"C-1","retrieved":True},
        {"source_kind":"decision","source_id":"decision:authority","requirement_id":"decision-authority","decision_id":"D-1","authority":"SOA","retrieved":True},
        {"source_kind":"ci_run","source_id":"ci:fresh","requirement_id":"source-freshness","run_id":116,"status":"completed","outcome":"success","retrieved":True,"observed_at":"2026-09-26T00:00:00Z","freshness_max_age_seconds":86400},
        {"source_kind":"receipt","source_id":"receipt:validation","requirement_id":"validation-receipt","receipt_id":"V-1","retrieved":True},
    ]
    result = run_memory_cycle_from_sources(
        sources,
        as_of="2026-09-26T01:00:00Z",
        controls=[{"control_id":"source-adaptation","executed":True,"changed_outcome":True}],
    )
