...
# Bootstrap RG: isolated from P0 and from the Terraform-managed SOA Intelligence DEV RG.
...
if ($AuthorizeIam) {
    ...
    # Read-only preflight roles only. No Contributor role is granted here.
